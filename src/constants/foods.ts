...
export const FOOD_CONSTANTS: FoodConstant[] = [
  ...
  },
  {
    ...
    unitType: "piece",
    category: "carbs",
    description: "Single slice of whole wheat bread (~80g)",
  },
  {
    id: "bran-tortilla-bread-large",
    name: "🍞 Large Bran Tortilla Bread",
    caloriesPerUnit: 250,
    unitType: "piece",
    category: "carbs",
    description: "Single slice of bran tortilla bread (~50g)",
  },
  {
    id: "bran-tortilla-bread-small",
    name: "🍞 Small Bran Tortilla Bread",
    caloriesPerUnit: 140,
    unitType: "piece",
    category: "carbs",
  ...
  {
    id: "farm-frites-air-fried",
    name: "🍟 Farm Frites Air Fried",
    caloriesPerUnit: 200,
    unitType: "100g",
    category: "carbs",
    description: "Air fried farm frites",
  },
  ...
  {
    id: "mozzarella-cheese-light",
    name: "🧀 Mozzarella Cheese Light",
    caloriesPerUnit: 200,
    unitType: "100g",
    category: "dairy",
    description: "Light mozzarella cheese",
  },
...
export function calculateCalories(
  ...
  if (
    food.unitType === "100ml" &&
    (inputUnit === "pieces" || inputUnit === "grams")
  ) {
