...
interface AddHouseExpenseModalProps {
  isOpen: boolean;
  onClose: () => void;
  ...
  editingExpense?: HouseExpense | null;
}

export default function AddHouseExpenseModal({
  isOpen,
  onClose,
  onAddExpense,
  onEditExpense,
  editingExpense,
}: AddHouseExpenseModalProps) {
    ...
    <ModalContainer
      ...
      title={
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          {isEditMode ? "Edit House Expense" : "Add House Expense"}
        </div>
      }
      maxWidth={600}
