...
interface AddWeddingExpenseModalProps {
  isOpen: boolean;
  onClose: () => void;
  ...
  editingExpense?: WeddingExpense | null;
}

export default function AddWeddingExpenseModal({
  isOpen,
  onClose,
  onAddExpense,
  onEditExpense,
  editingExpense,
}: AddWeddingExpenseModalProps) {
    ...
    <ModalContainer
      ...
      title={
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          {isEditMode ? "Edit Wedding Expense" : "Add Wedding Expense"}
        </div>
      }
      maxWidth={600}
